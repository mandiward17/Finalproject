...
means %>% 
  ...
  labs(title = "Profile Plot of Means", x = "Living Status", y = "BDI Score", fill = "Dating Status")
```
...
df_4 %>% 
  ...
  labs(title = "Boxplot of Means", x = "Dating Status", y = "BDI Score", fill = "Living Status")
